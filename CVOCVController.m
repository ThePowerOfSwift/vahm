...
OpenCvBlinkDetection *blinkDetection;
...
- (void)awakeFromNib
{
	...
	blinkDetection = [[OpenCvBlinkDetection alloc]init];
	
	//Create Growl Delegate
	[GrowlApplicationBridge setGrowlDelegate:self]; 
	
	[GrowlApplicationBridge notifyWithTitle:@"Blink Detection"
								description:@"Growl funktioniert.. :)" 
...
{ 
    NSArray* defaults = 
    [NSArray arrayWithObjects:@"Blink", nil]; 
